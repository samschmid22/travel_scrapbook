...
const variantClasses: Record<ButtonVariant, string> = {
  primary:
    "ds-btn-primary border border-[color-mix(in_oklab,var(--pink-dark),var(--pink-soft)_26%)] bg-[var(--pink-bright)] text-[var(--pink-soft)] hover:bg-[var(--accent-800)] focus-visible:ring-[var(--accent-300)] shadow-[0_20px_34px_-18px_rgba(255,71,162,0.68)]",
  secondary:
    "ds-btn-secondary border border-[color-mix(in_oklab,var(--pink-bright),var(--pink-soft)_44%)] bg-[var(--pink-soft)] text-[var(--text-on-light)] hover:bg-[color-mix(in_oklab,var(--pink-soft),var(--pink-bright)_24%)] hover:text-[var(--text-on-light-strong)] focus-visible:ring-[var(--accent-300)] shadow-[0_16px_30px_-24px_rgba(255,71,162,0.6)]",
  ghost:
