...
export function WelcomeGate({
  ...
  return (
    <div className="flex min-h-[100dvh] w-full items-center justify-center overflow-y-auto bg-[radial-gradient(circle_at_top,var(--pink-soft)_0%,color-mix(in_oklab,var(--pink-soft),var(--pink-bright)_24%)_52%,color-mix(in_oklab,var(--pink-soft),var(--gray-ref)_18%)_100%)] px-5 pb-[max(2.5rem,env(safe-area-inset-bottom))] pt-[max(2.5rem,env(safe-area-inset-top))]">
