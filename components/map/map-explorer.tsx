      ...
      <Card id="us-states-map" className="overflow-hidden p-0">
        ...
        <div className="grid gap-4 p-5 sm:p-6 xl:grid-cols-[1fr_320px]">
          <div className="space-y-4">
            ...
            <div
              className="rounded-2xl border border-[var(--border-soft)] bg-[linear-gradient(180deg,color-mix(in_oklab,var(--surface-3),var(--gray-ref)_30%)_0%,color-mix(in_oklab,var(--surface-3),var(--pink-bright)_14%)_100%)] p-2 sm:p-4"
          ...
          <div className="space-y-3">
            ...
            {selectedUSState ? (
              <div className="rounded-2xl border border-[color-mix(in_oklab,var(--border-soft),var(--pink-bright)_34%)] bg-[color-mix(in_oklab,var(--surface-3),var(--pink-bright)_12%)] p-4">
